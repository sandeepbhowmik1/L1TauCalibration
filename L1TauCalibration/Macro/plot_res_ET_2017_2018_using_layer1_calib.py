...
tMC_2018.Draw("L1Tau_RawIEt/2 / OfflineTau_pt >> hEt_raw_MC", "abs(OfflineTau_eta)<= 1.305")
tMC_2017.Draw("L1Tau_pt / OfflineTau_pt >> hEt_calib_MC_17", "abs(OfflineTau_eta) <= 1.305")
tMC_2018.Draw("L1Tau_pt / OfflineTau_pt >> hEt_calib_MC_18", "abs(OfflineTau_eta) <= 1.305")
#tMC_2018.Draw("L1Tau_RawIEt/2 / OfflineTau_pt >> hEt_raw_MC", "abs(OfflineTau_eta) >= 1.479, OfflineTau_isMatched == 1")
#tMC_2017.Draw("L1Tau_pt / OfflineTau_pt >> hEt_calib_MC_17", "OfflineTau_isMatched == 1", "OfflineTau_pt > 20")
#tMC_2018.Draw("L1Tau_pt / OfflineTau_pt >> hEt_calib_MC_18", "OfflineTau_isMatched == 1", "OfflineTau_pt > 20")
...
c1.Print("/home/sbhowmik/L1TauTrigger_NTuple/Calibration_2018data_180911/resolution_ET_MC_2017_2018_using_layer1_calib_180917_barrel.pdf", "pdf") 
c1.Print("/home/sbhowmik/L1TauTrigger_NTuple/Calibration_2018data_180911/resolution_ET_MC_2017_2018_using_layer1_calib_180917_barrel.png", "png")
